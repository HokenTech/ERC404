...
https://https://www.hokentech.tech//
https://t.me/HokenTech
...
contract HKT is ERC404 {
    string public dataURI;
    string public baseTokenURI;

    uint deckSize = 352;

    constructor() ERC404("HKT", "HKT", 18, deckSize, msg.sender) {
    ...
    function json(uint256 id) public view returns(string memory){
        ...
        string memory jsonPreImage = string.concat(
            string.concat(
                string.concat('{"name": "HKT #', string.concat( _cardID, string.concat('", "id":',  Strings.toString(id) ) ) ),
                ',"description":"A collection of 352 HKT enabled by ERC404, an experimental token standard.","external_url":"https://www.hokentech.tech/","image":"'
            ),
